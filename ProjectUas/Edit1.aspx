<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Edit1.aspx.vb" Inherits="ProjectUas.Edit1" %>
                                                    ...
                                                    <Columns>
														...
														<asp:TemplateField HeaderText="Scan Raport ">
															...
															<asp:Image ID="ScanRp" runat="server"
																	ImageUrl='<%# Eval("Id", "edit.ashx?Id={0}") + "&img=1"%>'
														...
														<asp:TemplateField HeaderText="SertifikatPrestasi ">
															...
															<asp:Image ID="Scanp" runat="server"
																	ImageUrl='<%# Eval("Id", "edit.ashx?Id={0}") + "&img=2"%>'
																	Width="200" Height="200" />
															</ItemTemplate>
														</asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PMBConnectionString %>" SelectCommand="SELECT [Id], [ScanRaport], [ScanSertifikatPrestasi], [ScanKTP], [PasFoto], [ScanKK], [ScanRS] FROM [PSUD]"></asp:SqlDataSource>
