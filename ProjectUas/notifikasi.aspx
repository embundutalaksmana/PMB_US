<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notifikasi.aspx.vb" Inherits="ProjectUas.notifikasi" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Notifikasi</span>
												</h3>
                                            <h3 class="card-title align-items-start flex-column">
												&nbsp;</h3>
