<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditROHIL.aspx.vb" Inherits="ProjectUas.EditROHIL1" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-body">
											...
											<div id="">
											    ...
											    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PMBConnectionString %>" SelectCommand="SELECT [ScanRaport], [ScanSertifikatPrestasi], [Id] FROM [ROHIL]">
                                                </asp:SqlDataSource>
                                                    ...
                                                    <Columns>
														...
														<asp:TemplateField HeaderText="Scan Raport ">
															...
															<asp:Image ID="ScanRp" runat="server"
																	ImageUrl='<%# Eval("Id", "EditROHIL.ashx?Id={0}") + "&img=1"%>'
														...
														<asp:TemplateField HeaderText="SertifikatPrestasi ">
															...
															<asp:Image ID="Scanp" runat="server"
																	ImageUrl='<%# Eval("Id", "EditROHIL.ashx?Id={0}") + "&img=2"%>'
																	Width="200" Height="200" />
															</ItemTemplate>
														</asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PMBConnectionString %>" SelectCommand="SELECT [Id], [Verfikasi], [NISN] FROM [ROHIL]" DeleteCommand="DELETE FROM [ROHIL] WHERE [Id] = @Id" InsertCommand="INSERT INTO [ROHIL] ([Verfikasi], [NISN]) VALUES (@Verfikasi, @NISN)" UpdateCommand="UPDATE [ROHIL] SET [Verfikasi] = @Verfikasi, [NISN] = @NISN WHERE [Id] = @Id">
                                                    <DeleteParameters>
