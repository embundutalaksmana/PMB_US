<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="panduan.aspx.vb" Inherits="ProjectUas.panduan" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Panduan</span></h3>
										...
										<div class="card-body">
                                            ...
                                            <p class="card-title align-items-start flex-column">
												<asp:Image ID="Image1" runat="server" Height="600px" ImageUrl="~/assets/Isi Biodata Terlebih dahulu.png" />
											</p>
