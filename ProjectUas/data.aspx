<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="data.aspx.vb" Inherits="ProjectUas.data" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Data Pribadi</span>
				...
				<table class="auto-style4"align=center >
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#FFCCFF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Horizontal" Height="277px" Width="1062px">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TanggalLahir" DataFormatString="{0:yyyy-MM-dd}" HeaderText="TanggalLahir" SortExpression="TanggalLahir" />
                                                ...
                                                <asp:BoundField DataField="kodepos" HeaderText="kodepos" SortExpression="kodepos" />
                                                <asp:BoundField DataField="hp" HeaderText="hp" SortExpression="hp" />
                                                <asp:BoundField DataField="TahunLulus" HeaderText="TahunLulus" SortExpression="TahunLulus" />
                                                <asp:BoundField DataField="Jurusan" HeaderText="Jurusan" SortExpression="Jurusan" />
                                                <asp:BoundField DataField="NamaSekolah" HeaderText="NamaSekolah" SortExpression="NamaSekolah" />
                                                <asp:BoundField DataField="AlamatSekolah" HeaderText="AlamatSekolah" SortExpression="AlamatSekolah" />
                                                <asp:BoundField DataField="NPSN" HeaderText="NPSN" SortExpression="NPSN" />
                                            </Columns>
                                ...
                                <tr>
                                    <td class="auto-style5">
                                        <asp:Button ID="Button1" runat="server" Text="Input" Height="29px" Width="121px" />
                                    </td>
                                    <td class="auto-style5">
												<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PMBConnectionString %>" SelectCommand="SELECT [NISN], [Nama], [NIK], [TanggalLahir], [JenisKelamin], [Agama], [Alamat], [kodepos], [hp], [TahunLulus], [Jurusan], [NamaSekolah], [AlamatSekolah], [NPSN] FROM [DataMaba] WHERE ([NISN] = @NISN)">
                                                    <SelectParameters>
