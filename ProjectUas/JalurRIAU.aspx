<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="JalurRIAU.aspx.vb" Inherits="ProjectUas.JalurRiau" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Form Pendaftaran Jalur Beasiswa Pemprov Riau</span><span class="text-muted mt-1 fw-bold fs-7">*Mohon di lengkapi berkas terlebih dahulu sebelum mengisi form</span>
											</h3>
