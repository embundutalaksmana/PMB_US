<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditYUS.aspx.vb" Inherits="ProjectUas.EditYUS" %>
                                                    ...
                                                    <Columns>
														...
														<asp:TemplateField HeaderText="Scan Raport ">
															...
															<asp:Image ID="ScanRp" runat="server"
																	ImageUrl='<%# Eval("Id", "EditYUS1.ashx?Id={0}") + "&img=1"%>'
														...
														<asp:TemplateField HeaderText="SertifikatPrestasi ">
															...
															<asp:Image ID="Scanp" runat="server"
																	ImageUrl='<%# Eval("Id", "EditYUS1.ashx?Id={0}") + "&img=2"%>'
																	Width="200" Height="200" />
															</ItemTemplate>
														</asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PMBConnectionString %>" SelectCommand="SELECT [Id], [Verfikasi], [NISN] FROM [YUS]" DeleteCommand="DELETE FROM [YUS] WHERE [Id] = @Id" InsertCommand="INSERT INTO [YUS] ([Verfikasi], [NISN]) VALUES (@Verfikasi, @NISN)" UpdateCommand="UPDATE [YUS] SET [Verfikasi] = @Verfikasi, [NISN] = @NISN WHERE [Id] = @Id">
                                                    <DeleteParameters>
