...
Public Class JalurPSUD
    ...
    Protected Sub Upload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Upload.Click
        ...
        If SR.PostedFile IsNot Nothing AndAlso
            ...
            cmd.CommandText = "INSERT INTO PSUD(Pilihan1, Pilihan2, Pilihan3, ScanRaport, ScanSertifikatPrestasi, PasFoto, ScanKK, ScanKTP, MTK1, MTK2, MTK3, MTK4, ENGLISH1, ENGLISH2, ENGLISH3, ENGLISH4, LAIN1, LAIN2, LAIN3, LAIN4, NISN, ScanRS) VALUES (@Pilihan1, @Pilihan2, @Pilihan3, @ScanRaport, @ScanSertifikatPrestasi, @PasFoto, @ScanKK, @ScanKTP, @MTK1, @MTK2, @MTK3, @MTK4, @ENGLISH1, @ENGLISH2, @ENGLISH3, @ENGLISH4, @LAIN1, @LAIN2, @LAIN3, @LAIN4, @NISN, @ScanRS)"
