<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="jalur_pendaftaran.aspx.vb" Inherits="ProjectUas.jalur_pendaftaran" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Jalur Pendaftaran</span>
												<span class="text-muted mt-1 fw-bold fs-7">Berikut beberapa jalur yang tersedia</span>
											</h3>
										...
										<div class="card-body">
											...
											<div id="">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<a href="JalurYUS.aspx" class="btn btn-light-primary" style="width: 500px; height: 120px" >
													<div class="col-md-15">
													<h1><strong>Pendaftaran Beasiswa Prestasi YUS</strong></h1>
													<hr>
												<i class="fa fa-calendar-check"></i> Batas Pendaftaran : 10 Maret 2023
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<i class="fa fa-file"></i> Seleksi Berkas																		
													</div>
												</a>
												...
												<a href="JalurRIAU.aspx" class="btn btn-light-primary" style="width: 500px; height: 120px" >
													<div class="col-md-15">
													<h1><strong>Pendaftaran Beasiswa Pemprov RIAU</strong></h1>
													<hr>
												<i class="fa fa-calendar-check"></i> Batas Pendaftaran : 10 Maret 2023
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<i class="fa fa-file"></i> Seleksi Berkas																		
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<a href="JalurROHIL.aspx" class="btn btn-light-primary" style="width: 500px; height: 120px" >
													<div class="col-md-15">
													<h1><strong>Pendaftaran Beasiswa Pemda ROHIL</strong></h1>
													<hr>
												<i class="fa fa-calendar-check"></i> Batas Pendaftaran : 10 Maret 2023
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<i class="fa fa-file"></i> Seleksi Berkas																		
												...
												<a href="JalurPSUD.aspx" class="btn btn-light-primary" style="width: 500px; height: 120px" >
													<div class="col-md-15">
													<h1><strong>Pendaftaran Jalur PSUD</strong></h1>
													<hr>
												<i class="fa fa-calendar-check"></i> Batas Pendaftaran : 10 Maret 2023
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<i class="fa fa-file"></i> Seleksi Berkas																		
