<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="JalurROHIL.aspx.vb" Inherits="ProjectUas.JalurROHIL" %>
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Form Pendaftaran Jalur Beasiswa Pemda ROHIL</span><span class="text-muted mt-1 fw-bold fs-7">*Mohon di lengkapi berkas terlebih dahulu sebelum mengisi form</span>
											</h3>
					...
					<table style="width:105%;" >
                        ...
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:SqlDataSource ID="PSUD" runat="server" CancelSelectOnNullParameter="False" ConnectionString="<%$ ConnectionStrings:PMBConnectionString %>" DeleteCommand="DELETE FROM [ROHIL] WHERE [Id] = @Id" InsertCommand="INSERT INTO ROHIL(Id, Pilihan1, Pilihan2, Pilihan3, ScanRaport, ScanSertifikatPrestasi, PasFoto, ScanKK, ScanKTP, MTK1, MTK2, MTK3, MTK4, ENGLISH1, ENGLISH2, ENGLISH3, ENGLISH4, LAIN1, LAIN2, LAIN3, LAIN4, NISN, ScanRS, ScanPB) VALUES (@Id, @Pilihan1, @Pilihan2, @Pilihan3, @ScanRaport, @ScanSertifikatPrestasi, @PasFoto, @ScanKK, @ScanKTP, @MTK1, @MTK2, @MTK3, @MTK4, @ENGLISH1, @ENGLISH2, @ENGLISH3, @ENGLISH4, @LAIN1, @LAIN2, @LAIN3, @LAIN4, @NISN, @ScanRS, @ScanPB)" SelectCommand="SELECT [Id], [Pilihan1], [Pilihan2], [Pilihan3], [ScanRaport], [ScanSertifikatPrestasi], [PasFoto], [ScanKK], [ScanKTP], [MTK1], [MTK2], [MTK3], [MTK4], [ENGLISH1], [ENGLISH2], [ENGLISH3], [ENGLISH4], [LAIN1], [LAIN2], [LAIN3], [LAIN4], [NISN], [ScanRS], [ScanPB] FROM [ROHIL]" UpdateCommand="UPDATE [ROHIL] SET [Pilihan1] = @Pilihan1, [Pilihan2] = @Pilihan2, [Pilihan3] = @Pilihan3, [ScanRaport] = @ScanRaport, [ScanSertifikatPrestasi] = @ScanSertifikatPrestasi, [PasFoto] = @PasFoto, [ScanKK] = @ScanKK, [ScanKTP] = @ScanKTP, [MTK1] = @MTK1, [MTK2] = @MTK2, [MTK3] = @MTK3, [MTK4] = @MTK4, [ENGLISH1] = @ENGLISH1, [ENGLISH2] = @ENGLISH2, [ENGLISH3] = @ENGLISH3, [ENGLISH4] = @ENGLISH4, [LAIN1] = @LAIN1, [LAIN2] = @LAIN2, [LAIN3] = @LAIN3, [LAIN4] = @LAIN4, [NISN] = @NISN, [ScanRS] = @ScanRS, [ScanPB] = @ScanPB WHERE [Id] = @Id">
                                    <DeleteParameters>
